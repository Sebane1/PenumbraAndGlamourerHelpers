            ...
            try
            {
                ...
                foreach (var mod in activeMods)
                {
                    ...
                    foreach (var key in files.Keys)
                    {
                        ...
                        if ((lowerKey.Contains("_b_d") || lowerKey.Contains("_b_n") || lowerKey.Contains("_b_s") || lowerKey.Contains("_b_m")) && lowerKey.Contains("obj/body")) tbseCount++;
                    }
                    ...
                    else if (bodyTypeCount > 1)
                    {
                        ...
                        if (gender != 0) { if (lnm.Contains("bibo") || lnm.Contains("yab") || lnm.Contains("b+") || ldr.Contains("bibo")) return 1; if (lnm.Contains("gen3") || lnm.Contains("tight & firm") || System.Text.RegularExpressions.Regex.IsMatch(lnm, @"(^|[^a-z])eve([^a-z]|$)") || lnm.Contains("exqb") || lnm.Contains("pythia") || lnm.Contains("gaia") || ldr.Contains("gen3") || ldr.Contains("exqb") || ldr.Contains("pythia") || ldr.Contains("gaia")) return 2; } if (gender != 1) { if (lnm.Contains("tbse") || ldr.Contains("tbse") || lnm.Contains("hrbody") || ldr.Contains("hrbody") || lnm.Contains("swole") || ldr.Contains("swole") || lnm.Contains("hunk") || ldr.Contains("hunk") || lnm.Contains("the body") || ldr.Contains("the body")) return 3; }
                    ...
                    else
                    {
                        ...
                        if (gender != 1) {
                            if (lnm.Contains("tbse") || ldr.Contains("tbse") || lnm.Contains("hrbody") || ldr.Contains("hrbody") || lnm.Contains("swole") || ldr.Contains("swole") || lnm.Contains("hunk") || ldr.Contains("hunk") || lnm.Contains("the body") || ldr.Contains("the body")) { detectedModName = mod.Name; plugin?.PluginLog?.Information($"[Drag And Drop Debug] Body detected via name: '{mod.Name}' -> TBSE"); return 3; }
                        }
                    }
                }
            }
